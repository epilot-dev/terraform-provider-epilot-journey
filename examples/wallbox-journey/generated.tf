...
resource "epilot-journey_journey" "grid_journey" {
  ...
  journey_id = "dca9f240-83d2-11ee-b475-5b191f85c600"
  logics = [
    {
  ...
  name            = "Hausanschluss Kombi Strom, Gas, Wasser, Fernwärme - Mehrsparte"
  organization_id = "13439043"
  rules           = null
  settings = {
    address_suggestions_file_url = null
    description                  = null
    design_id                    = "395fea23-158f-4630-a5ae-56691ea24591"
    embed_options                = null
    entity_id                    = "907579a1-e068-454e-bf7e-45ac5c9179e7"
    entity_tags                  = null
    file_purposes                = null
    mappings_automation_id       = "a21f393a-84fc-4ccc-bd1c-5f3f422ad997"
    organization_settings        = null
    public_token                 = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6ImI3ZlZ4TW1WM00wOG5XMXRWYjZSaXVscUVLVzNlZGpsUUwyZk1ndkdQX1EifQ..NFKP-n5T-X0nPODxZW48y206ir5zBomkWNmXTeqYKkzwxwBI5NHcZ6oceHXHP61RpU8w6IU6XwJ-RADz8gjJUCTVEw9scQJq3vG18ppP2LA7U8eTxNv0kU7n6q6WQF_9mhkcddfN1x4ffZZgiPlX70FeD5bn7dtaYSEISjPCxf-MM-nKRhWcNY-yej8YlxkobkjoE0n5OhChUcVOCZ0JoAYJ-gYEhrkQ9r3PB9j_AU_HIo7NBg_6U1NOGU9mukQVsEuBaMwic-3DEpZwwPVicKXymqqAnE1c62UgMZWEyesoBlNcfrMDgFG0KG83Y0EQ--ovSLoIPqxudV6qyO2IaA"
